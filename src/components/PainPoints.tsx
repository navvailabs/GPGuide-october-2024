    ...
    return (
        <section id="features" className="relative overflow-hidden py-16 md:py-24 bg-brand-bg">
            ...
            <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h2 className="text-mobile-h2 md:text-desktop-h2 font-bold text-brand-text">The Hidden Cost of GP Documentation</h2>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className={`w-full pl-12 md:pl-0 ${isRightSide ? 'md:pl-[calc(50%+2.5rem)]' : 'md:pr-[calc(50%+2.5rem)]'}`}>
                                        <motion.div 
                                            className="bg-brand-surface border border-brand-border rounded-2xl p-6 shadow-layered-lg transition-all duration-300 hover:border-brand-border/80 hover:shadow-layered-xl"

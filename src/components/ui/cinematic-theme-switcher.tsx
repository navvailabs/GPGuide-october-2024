  ...
  return (
    <div className="relative inline-block">
      ...
      <motion.button
        ...
        className="relative flex h-[48px] w-[80px] items-center rounded-full p-[4px] transition-all duration-300 focus:outline-none"
        style={{
          background: isDark
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-between px-3">
          <Sun size={16} className={isDark ? 'text-yellow-100' : 'text-amber-600'} />
          <Moon size={16} className={isDark ? 'text-yellow-100' : 'text-slate-700'} />
        </div>

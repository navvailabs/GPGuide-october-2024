    ...
    return (
        <section id="faq" className="py-20 sm:py-24">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h2 className="text-mobile-h2 md:text-desktop-h2 font-bold text-brand-text">Frequently Asked Questions</h2>
                ...
                <div className="max-w-4xl mx-auto">
                    {Object.entries(faqData).map(([category, items]) => (
                        <motion.div 
                            ...
                            transition={{ duration: 0.5 }}
                        >
                            <h3 className="text-2xl font-bold mb-8 text-center text-brand-text">{category}</h3>

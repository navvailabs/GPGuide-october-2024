        ...
        <div className="space-y-24 md:space-y-32">
          {featuresData.map((feature, index) => {
            ...
            return (
                ...
                >
                  <div className={cn({
                    'md:order-2': isEven, // For index 0 (first item), image is on the right
                    'md:order-1': !isEven, // For index 1 (second item), image is on the left
                  })}>
                    <motion.div 
                  ...
                  <div className={cn('text-center md:text-left', {
                    'md:order-1': isEven, // For index 0, text is on the left
                    'md:order-2': !isEven, // For index 1, text is on the right
                  })}>

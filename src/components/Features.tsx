    ...
    return (
        <section className="py-20 sm:py-24 text-brand-text">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h2 className="text-mobile-h2 md:text-desktop-h2 font-bold text-brand-text">Stop Spending Hours on Paperwork</h2>
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-20">
                    {primaryFeatures.map((feature, index) => (
                        <motion.div
                            ...
                            className="bg-brand-surface border border-brand-border rounded-2xl p-8 flex flex-col h-full"
                ...
                >
                    <h3 className="text-3xl font-bold mb-12 text-brand-text">Transform Your Practice Starting Today</h3>
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {achievements.map((item, index) => (
                            <motion.div
                                key={item.title}
                                className="bg-brand-surface border border-brand-border rounded-2xl p-6 text-center transition-all duration-300 hover:border-brand-accent/50 hover:-translate-y-2"

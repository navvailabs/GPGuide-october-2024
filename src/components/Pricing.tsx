    ...
    return (
        <section id="pricing" className="py-20 sm:py-24 text-brand-text">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h2 className="text-mobile-h2 md:text-desktop-h2 font-bold text-brand-text">Choose Your Productivity Plan</h2>
                ...
                <div className="grid lg:grid-cols-2 gap-8 max-w-4xl mx-auto lg:items-stretch">
                    {plans.map((plan, index) => (
                        <motion.div
                            ...
                            className="h-full"
                        >
                            <AnimatedCard className={cn(plan.isPopular ? 'border-brand-accent/60' : '')}>
                                {plan.isPopular && (
